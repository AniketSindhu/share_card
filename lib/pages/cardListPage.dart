...
class _CardListState extends State<CardList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        leadingWidth: 10,
        title: tr("home").toString().text.semiBold.size(20).white.make(),
        actions: [
          GestureDetector(
            onTap: () {
      ...
      body: user != null || card != null
                          ...
                          FutureBuilder(
                            ...
                            builder:
                              ...
                              if (snapshot.connectionState ==
                                ...
                                return VxBox()
                                    .gray500
                                    .width(context.percentHeight * 95)
                                    .height(250)
                                    .makeCentered()
                                    .shimmer();
                              } else {
                                                                ...
                                                                onPressed:
                                                                  ...
                                                                  if (await Permission
                                                                    ...
                                                                    await ContactsService.addContact(Contact(
                                                                        displayName: card1.firstName +
                                                                            ' ' +
                                                                            card1
                                                                                .secondName,
                                                                        givenName: card1.firstName +
                                                                            ' ' +
                                                                            card1
                                                                                .secondName,
                                                                        company:
                                                                        ...
                                                                        androidAccountType:
                                                                            AndroidAccountType
                                                                                .other,
                                                                        androidAccountName: card1.firstName +
                                                                            ' ' +
                                                                            card1.secondName));
                                                                    context.showToast(
                                                                        msg: tr('contact_added')
                                                                            .toString(),
                                                                        bgColor: Vx
                                                                            .green500,
                                                                        textColor:
                          ...
                          FutureBuilder(
                            ...
                            builder:
                              ...
                              if (snapshot.connectionState ==
                                ...
                                if (snapshot.data.data()['recieved_cards'] ==
                                    null) {
                                  return Container();
                                } else {
                                  return Column(
                                      ...
                                      if (card1.specialization
                                        ...
                                        return Column(
                                          children: [
                                            ListTile(
                                              title:
                                                  "${card1.firstName} ${card1.secondName}"
                                                      .text
                                                      .make(),
                                              subtitle: card1
                                                  .specialization.text
          ...
          : Column(
              ...
              children: [
                ...
                (20).heightBox,
                tr("no_card").toString().text.semiBold.size(18).makeCentered()
              ],
            ),
    );
  }
