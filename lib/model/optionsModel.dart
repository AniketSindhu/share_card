...
List<OptionsModel> optionList=[
  ...
  OptionsModel(icon:Icon(Icons.settings,color:Colors.blue[700],size:20),name:"Premium",onTap: (){
    Get.to(Premium());
  }),
  OptionsModel(icon:Icon(Icons.settings,color:Colors.blue[700],size:20),name:"Theme",onTap: (){
    Get.dialog(ThemeConsumer(child: ThemeDialog()));
  }),
  OptionsModel(icon:Icon(Icons.settings,color:Colors.blue[700],size:20),name:"History",onTap: (){
    Get.to(History());
  }),
  OptionsModel(icon:Icon(Icons.settings,color:Colors.blue[700],size:20),name:"language",onTap: (){}),
  OptionsModel(icon:Icon(Icons.settings,color:Colors.blue[700],size:20),name:"Rate us",onTap: (){
    Get.dialog(Dialog(
      child:Container(
        height: 250,
        width: 300,
        child: Center(
          child: Column(
            children: [
              ...
              Center(
                child: FlatButton(
                  child: Text('Rate',style: TextStyle(color: Colors.white,fontSize: 18,),),
                  color: Colors.green,
                  onPressed: (){},
                ),
              )
